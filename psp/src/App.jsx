...
import { PremiumPage, TournamentsPage, TeamsPage, PartnersPage } from './pages/CommercePages.jsx';
import { NewsPage, FeedbackPage, ContactsPage, PrivacyPage, RulesPage, FaqPage } from './pages/ContentPages.jsx';
import { ProjectPage, DesignDocumentPage, PrototypePage, TestingPage, RoadmapPage } from './pages/ProjectPages.jsx';
...
export default function App() {
  ...
  const page = useMemo(() => {
    switch (route) {
      ...
      case 'design-document': return <DesignDocumentPage />;
      ...
      default: return <GenericPage title="404 — страница не найдена" text="Такой страницы нет. Вернись на главную или выбери раздел в меню." />;
    }
