...
export const defaultTestResults = [
  ...
  },
  {
    ...
    fixed: 'Добавлен раздел О проекте и Premium',
  },
  {
    id: 5,
    tester: 'Партнёр',
    ...
    fixed: 'Добавлена страница Партнёрам',
  },
];
...
export const requirementChecklist = [
  ...
  'Результаты юзабилити-тестирования и исправления',
];
...
export const navigation = [
  ...
  { path: 'project', label: 'О проекте', icon: 'news', group: 'project' },
  { path: 'design-document', label: 'Дизайн-документ', icon: 'news', group: 'project' },
  { path: 'prototype', label: 'Прототип', icon: 'map', group: 'project' },
  { path: 'testing', label: 'Тестирование', icon: 'shield', group: 'project' },
  { path: 'roadmap', label: 'Roadmap', icon: 'chart', group: 'project' },
  { path: 'partners', label: 'Партнёрам', icon: 'trophy', group: 'commerce' },
